...
export const mockCongressUpdates = [
  {
    id: '1',
    title: 'Khai mạc Đại hội',
    description: 'Lễ khai mạc Đại hội Hội sinh viên lần thứ X nhiệm kỳ 2024-2026 với sự tham dự của 150 đại biểu từ 15 khoa/viện.',
  ...
  },
  {
    ...
    description: 'Trình bày báo cáo tổng kết các hoạt động và thành tích của Hội sinh viên trong nhiệm kỳ vừa qua.',
    location: 'Hội trường A, ĐHQG-HCM',
  ...
  },
  {
    ...
    description: 'Đại hội đã tiến hành bầu cử và bầu ra 23 đồng chí vào Ban chấp hành Hội sinh viên nhiệm kỳ 2024-2026. Các đồng chí được bầu đều là những sinh viên xuất sắc, có uy tín và nhiệt huyết với công tác Hội.',
    location: 'Hội trường A, ĐHQG-HCM',
  ...
  },
  {
    id: '4',
    title: 'Thảo luận tổ',
    description: 'Các đại biểu thảo luận về báo cáo hoạt động và đóng góp ý kiến cho kế hoạch nhiệm kỳ mới.',
  ...
  },
  {
    ...
    description: 'Lễ bế mạc Đại hội và công bố kết quả bầu cử Ban chấp hành mới.',
    location: 'Hội trường A, ĐHQG-HCM',
...
// Thêm mock data cho tài liệu
export const mockDocuments = [
  {
    id: '1',
    title: 'Nghị quyết Đại hội Hội sinh viên lần thứ X',
    description: 'Nghị quyết chính thức của Đại hội với các mục tiêu và định hướng cho nhiệm kỳ 2024-2026',
    fileUrl: '#',
    fileType: 'PDF',
    fileSize: '2.5 MB',
    category: 'Nghị quyết',
  ...
  },
  {
    id: '2',
    title: 'Báo cáo hoạt động nhiệm kỳ 2022-2024',
    description: 'Báo cáo tổng kết đầy đủ các hoạt động và thành tích của Hội sinh viên trong nhiệm kỳ vừa qua',
    fileUrl: '#',
    fileType: 'PDF',
    fileSize: '5.2 MB',
    category: 'Báo cáo',
  ...
  },
  {
    ...
    description: 'Danh sách 150 đại biểu chính thức tham dự Đại hội từ 15 khoa/viện',
    fileUrl: '#',
    fileType: 'Excel',
    fileSize: '1.8 MB',
    category: 'Danh sách',
  ...
  },
  {
    ...
    description: 'Quy chế và thể lệ tổ chức Đại hội Hội sinh viên lần thứ X',
    fileUrl: '#',
    fileType: 'PDF',
    fileSize: '3.1 MB',
    category: 'Quy chế',
...
// Thêm mock data cho thông tin cập nhật đại hội
export const mockCongressInfo = [
  {
    id: '1',
    title: 'Đã bầu ra 23 đồng chí vào Ban chấp hành',
    content: 'Đại hội đã tiến hành bầu cử thành công và bầu ra 23 đồng chí vào Ban chấp hành Hội sinh viên nhiệm kỳ 2024-2026. Các đồng chí được bầu đều là những sinh viên xuất sắc, có uy tín cao và nhiệt huyết với công tác Hội.',
    imageUrl: 'https://readdy.ai/api/search-image?query=Vietnamese%20university%20student%20election%20results%20with%2023%20newly%20elected%20executive%20committee%20members%20in%20formal%20group%20photo%2C%20professional%20academic%20setting%2C%20congratulatory%20atmosphere%20with%20flowers%20and%20official%20banners%2C%20bright%20lighting&width=800&height=500&seq=info1&orientation=landscape',
    isHighlight: true,
    createdAt: '2024-12-21T11:00:00Z',
  ...
  },
  {
    ...
    content: 'Đại hội đã thông qua Nghị quyết với 5 mục tiêu chính cho nhiệm kỳ 2024-2026, tập trung vào phát triển học thuật, tình nguyện cộng đồng, văn hóa thể thao, hỗ trợ sinh viên và hợp tác quốc tế.',
    imageUrl: 'https://readdy.ai/api/search-image?query=Vietnamese%20university%20congress%20resolution%20document%20signing%20ceremony%2C%20official%20papers%20on%20table%2C%20student%20leaders%20and%20faculty%20members%2C%20formal%20academic%20atmosphere%2C%20professional%20lighting&width=800&height=500&seq=info2&orientation=landscape',
    isHighlight: false,
    createdAt: '2024-12-21T10:00:00Z',
    updatedAt: '2024-12-21T10:00:00Z'
  }
